      ...
      <div className="bg-white rounded-xl shadow-md p-6 space-y-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <img src={selectedImage || formData.avatar || "/avatar-holder.avif"
            }
            alt="/avatar-holder.avif"
            className="w-32 h-32 rounded-full object-cover object-top border-4 border-gray-200"
            />
            <label htmlFor="avatar-upload" className={`absolute bottom-0 right-0 bg-gray-800 hover:scale-105 p-2 rounded- full cursor-pointer transitioon-all duration-200 ${
        ...
        {/* ACCOUNT INFO  */}
        <div className="mt-6 bg-gray-50 border-gray-200 rounded-x1 p-6">
