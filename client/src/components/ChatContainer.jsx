...
const ChatContainer = () => {
  ...
  return (
    <>
      <div className="flex-1 flex flex-col overflow-hidden border  rounded-2xl shadow-xl  dark:border-white/10">
        <ChatHeader />
                ...
                >
                  ...
                  <div
                    className={`max-w-xs sm:max-w-sm md:max-w-md px-4 py-2 rounded-xl text-sm ${
                      isSender
                        ? "bg-cyan-600 text-white shadow-md rounded-2xl px-3 py-2"
                        : "shadow-sm rounded-2xl px-3 py-2 bg-emerald-100 text-emerald-900 dark:bg-emerald-700 dark:text-emerald-50"
                    }`}
                  >
                    {message.media && (
                      <>
